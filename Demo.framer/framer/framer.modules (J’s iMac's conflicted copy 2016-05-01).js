    ...
    if (layer.constraints) {
      ...
      if (layer.constraints.bottom !== void 0) {
        if (layer.constraints.bottom === parseInt(layer.constraints.bottom, 10)) {
          ...
          if (layer.constraints.bottom[0].calculatedPosition === void 0) {
            exports.animateLayout({
