	...
	for layer, index in targetLayers
		...
		if layer.constraints
			...
			if layer.constraints.leadingEdges != undefined
				...
				if layer.constraints.leadingEdges.calculatedPosition.x == undefined
			...
			if layer.constraints.trailingEdges != undefined
				...
				if layer.constraints.trailingEdges.calculatedPosition.x == undefined
			...
			if layer.constraints.topEdges != undefined
				...
				if layer.constraints.topEdges.calculatedPosition.y == undefined
			...
			if layer.constraints.bottomEdges != undefined
				...
				if layer.constraints.bottomEdges.calculatedPosition.y == undefined
			...
			if layer.constraints.leading != undefined
				...
				if layer.constraints.leading == parseInt(layer.constraints.leading, 10)
					...
					if layer.constraints.leading.length == undefined
						...
						if layer.constraints.leading.calculatedPosition.x == undefined
					...
					#If it's a relationship
						...
						if layer.constraints.leading[0].calculatedPosition.x == undefined
			...
			if layer.constraints.trailing != undefined
				...
				if layer.constraints.trailing == parseInt(layer.constraints.trailing, 10)
					...
					if layer.constraints.trailing.length == undefined
						...
						if layer.constraints.trailing.calculatedPosition.x == undefined
					...
					#If it's a relationship
						...
						if layer.constraints.trailing[0].calculatedPosition.x == undefined
			...
			if layer.constraints.top != undefined
				...
				if layer.constraints.top == parseInt(layer.constraints.top, 10)
					...
					if layer.constraints.top.length == undefined
						...
						if layer.constraints.top.calculatedPosition.y == undefined
					...
					#If it's a relationship
						...
						if layer.constraints.top[0].calculatedPosition.y == undefined
			...
			if layer.constraints.bottom != undefined
				...
				if layer.constraints.bottom == parseInt(layer.constraints.bottom, 10)
					...
					if layer.constraints.bottom.length == undefined
						...
						if layer.constraints.bottom.calculatedPosition.y == undefined
					...
					#If it's a relationship
						...
						if layer.constraints.bottom[0].calculatedPosition.y == undefined
