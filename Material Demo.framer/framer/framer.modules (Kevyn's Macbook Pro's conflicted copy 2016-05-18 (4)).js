...
exports.create = function(array) {
  var bar, barArea, i, j, k, label, layer, len, len1, ref, ref1, setup, t, tab, title;
  setup = m.utils.setupComponent(array, exports.defaults);
  bar = new Layer({
    name: "App Bar",
